...
gcloud iam service-accounts keys create ~/.Recommendations-AI-Tutorial-Key.json --iam-account "$service_acc_email"

# activate the service account using the key
gcloud auth activate-service-account --key-file ~/.Recommendations-AI-Tutorial-Key.json

# install needed Google client libraries
cd ~/products/gcp/Recommendations-AI-Tutorial/samples
npm install
'success'